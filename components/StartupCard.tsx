  ...
  return (
    <li className='startup-card group'>
        ...
        <div className='flex justify-between mt-5 gap-1.5'>
            ...
            <Link href={`/user/${authorId}`}>
                <Image src="https://placehold.co/48x48.png" alt='placeholder' width={48} height={48} className='rounded-full'/>
            </Link>
        </div>
        <Link href={`/startup/${_id}`}>
            ...
            <Image src={image} alt='placeholder' className='startup-card_img'width={400} height={300}/>
        </Link>
